"use client"; // This component explicitly runs only on the client
...
export default function WalletConnectClient() {
  ...
  const handleSignMessage = async () => {
    ...
    try {
      ...
      // Type the error as unknown initially, then check its type
      let errorMessage = "An unexpected error occurred during signing.";
